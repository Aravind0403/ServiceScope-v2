#!/usr/bin/env python3
"""
ServiceScope Testimonial Checker: Jaeger Tracing System
======================================================
Clones, extracts, and infers service dependencies on the real-world
20k-star 'jaegertracing/jaeger' Go codebase.
"""
...
def main():
    repo_path = "benchmark/repos/jaeger"
    model = "llama3.1:8b"  # or qwen3:4b, using llama3.1:8b as default
    ollama_url = "http://localhost:11434"
    
    print("======================================================================")
    # Check if jaeger is cloned
    if not os.path.exists(repo_path):
        print("❌ Jaeger repository not found! Please clone it first.")
        return
        
    print(f"🚀 Running ServiceScope Jaeger Testimonial Evaluation")
    print("======================================================================\n")
    ...
    network_keys = ['addr', 'host', 'port', 'url', 'http', 'client', 'conn', 'dial', 'endpoint']
    prod_calls = [
    ...
    print(f"  Filtered network-only production calls: {len(network_calls)}\n")
    ...
    for i, call in enumerate(network_calls):
        ...
        print(f"  Inferring {i+1}/{len(network_calls)}: {caller} calls {raw_expr} ({method.upper()})...")
    ...
    print("\n==============================================================")
    print("      ServiceScope Mapped Jaeger Service Dependencies         ")
    print("==============================================================")
    ...
    print("\n==============================================================")
    print("      Computed Blast Radius from 'jaeger' component          ")
    print("==============================================================")
    try:
        blast = compute_blast_radius(graph, "jaeger", confidence_threshold=0.5)
        ...
        print(f"  Could not compute blast radius for 'jaeger': {e}")
