...
class Settings(BaseSettings):
    ...
    # ===== Bootstrap =====
    # Secret required to call the public tenant-creation endpoint.
    # Set this to a strong random value in production; leave as None to disable
    # the endpoint entirely once the first tenant has been created via the CLI.
